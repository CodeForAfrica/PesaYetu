    ...
    showCaseStories: [
      {
        ...
        brief: 'How true are these claims by General Katureebe Tayebwa on Uganda’s trade with Kenya?',
      ...
      {
        index: 1,
        title: 'Did Uganda earn more from gold than coffee for the first time in March 2019?',
        author: 'Arthur Kakande',
        brief:
      ...
      },
      {
        ...
        brief: 'How viable is Uganda’s plan to revive the country’s flag carrier?',
        link:
