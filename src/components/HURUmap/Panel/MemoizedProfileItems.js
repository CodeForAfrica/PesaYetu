...
const MemoizedProfileItems = memo(
  function MemoizedProfileItems({
    categories,
    dataNotAvailable,
...
MemoizedProfileItems.propTypes = {
...
MemoizedProfileItems.defaultProps = {
...
export default MemoizedProfileItems;
