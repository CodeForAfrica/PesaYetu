    ...
    <Page>
      ...
      >
        <Typography className={classes.p}>
          One essential tool that Kenyan citizens need to engage the government
          is information on how money collected from taxpayers is allocated.
          With this information, we can ask what our elected officials are doing
          with it, and from there the discussion can proceed towards how money
          is spent in the future to better our lives.
        </Typography>
        <Typography className={classes.p}>
          ...
          the national government allocates a share of national revenues using a
          set formula. This information is contained in copies of the Kenya
        ...
        <Typography className={classes.p}>
          ...
          tool designed to inform citizens on their local authority’s financial
          performance and allows comparisons between municipalities.
        </Typography>
      </Section>
